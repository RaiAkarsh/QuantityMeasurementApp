...
import QuantityApp.QuantityApp.*;
import QuantityApp.QuantityApp.dto.QuantityDTO;
import QuantityApp.QuantityApp.exception.QuantityMeasurementException;
...
public class QuantityMeasurementServiceImpl
    ...
    public boolean compare(QuantityDTO q1, QuantityDTO q2) {
        ...
        Quantity<IMeasurable> a =
                new Quantity<>(q1.getValue(), UnitFactory.getUnit(q1.getType(), q1.getUnit()));

        Quantity<IMeasurable> b =
                new Quantity<>(q2.getValue(),UnitFactory.getUnit(q2.getType(), q2.getUnit()));
