...
public class StandaloneUnitTest {
    ...
    void testConvertToBaseUnit_InchesToFeet() {
        assertEquals(1.0,
                StandaloneLengthUnit.INCHES.convertToBaseUnit(12.0),EPSILON);
    }

    @Test
    void testConvertFromBaseUnit_FeetToInches() {
        assertEquals(12.0,
        		StandaloneLengthUnit.INCHES.convertFromBaseUnit(1.0), EPSILON);
    }

    @Test
    void testConvertToBaseUnit_YardsToFeet() {
        assertEquals(3.0,
        		StandaloneLengthUnit.YARDS.convertToBaseUnit(1.0), EPSILON);
    }
